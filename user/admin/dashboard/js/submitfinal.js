...
var book_id = $("#b_id").html();        ///place all your jquery functions here///
            var page = 1;
            var fields = 1;
  ...
  setTimeout(function(){newWin.close();},10);
            ...
            $("#next").click(function(){
                ...
                if(page<=2){
                    ...
                    if(page==1){
                        if($("#title").val()==="" || $("#abstract").val()===""  ||  $("#keywords").val()==="" || $("#reference").val()==="" || $("#status").val()===""){
           ...
           $("#submit").click(function(){
            ...
            //alert(issn + " " + journal + " " + journaltype + " " + " " + jdate);
               // alert(email);
                ...
                //ajax post
               $.ajax({
                url:"savefinalpaper.php?book_id="+book_id,
                type:"POST",
                cache:false,
                ...
                success: function (data) {
                    ...
                    if(str[0]!="error"){
                       window.location.href = "acceptbook.php?book_id=" + book_id;
                    }else{
