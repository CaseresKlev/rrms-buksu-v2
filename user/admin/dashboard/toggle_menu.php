                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="<?php $x = array();
                                 echo PROJECT_ROOT . "user/admin/dashboard/messages/"  ?>" class="nav-link">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo PROJECT_ROOT . 'user/admin/dashboard/push_notification/' ?>"><i class="fas fa-bell fa-lg"></i>&nbsp; Notification
