          ...
          <?php
            ...
            if(isset($_GET['bid']) && !empty($_GET['bid'])){
              ...
              if($res->num_rows>0){
                ...
                include(PROJECT_ROOT_NOT_LINK . "user/admin/dashboard/paper/add-completed/add-author.php");
              }else{
                include(PROJECT_ROOT_NOT_LINK . "user/admin/dashboard/paper/add-completed/add-new.php");
              }
