<div class="container w-25 h-50 fixed-bottom ml-auto mr-4 bg-dark" id="chat-holder">
	<div class="card">
...
<style type="text/css">
  ...
  <!--<div class="row p-2 bg-danger">
  	<span class="mr-auto"><a class="text-white" href="#">Klevie Jun</a></span>
  		<button type="button" class="close ml-auto" aria-label="Close" onclick="hideChat()">
		  <span aria-hidden="true">&times;</span>
		</button>
  </div>
  <div class="row bg-success">
  	<div class="alert alert-info my-2 mx-2 mr-auto" style="max-width: 80%">
  		Hai po kumusta nah man ka? Hai po kumusta nah man ka?!
  	</div>
  </div>
  <div class="row bg-primary">
  	<input class="form-control"  type="text" name="chat" value="Hellow too!">
  </div>-->
</div>
...
<!--<div class="container bg-danger chat-header" style="height: 40px;">
  	<div class="row p-2">
  		
  	</div>
  
  </div>
  <div class="container bg-success h-100">
  	<div id="message-holder">
  		<div class="row mr-auto bg-info alert">
	  		hai
	  	</div>
  	</div>
  ...
  <div class="container bg-warning">
  	<div class="row">
  		<input type="text" name="msg" value="HHH">
  	</div>
  </div>-->