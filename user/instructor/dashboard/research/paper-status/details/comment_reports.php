                            ...
                            <table width="100%" id="tablesecond" class="tablesecond" style="padding: 0.75rem">
                              ...
                              <tbody>
                                ...
                                <tr style="border:1px solid black;">
                                  ...
                                  <div class="row sig">
                                    <img class="unofficial" src="<?php echo(PROJECT_ROOT . "img/unofficial.jpg"); ?>">
                                      ...
                                      <div class="col-md-6 signature">
                                        ...
                                        <footer>
                                          <div class="row text-danger mt-5 ml-auto mr-auto">Note: Unofficial Document! This is Electronic generated report intended for the instructors, signature not needed.</div>
                                          <table class="table" >
                                            <tr>
                                            <td scope="col">
