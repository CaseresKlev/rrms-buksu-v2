	...
	//print_r($_SESSION);
  	...
  	if(isset($_SESSION['uid'])){
  		if(isset($_POST)){  
  			...
  			$query = "INSERT INTO `book` (`book_id`, `book_title`, `abstract`, `pub_date`, `department`, `keywords`, `refrences`, `rev_count`, `status`, `enabled`, `views_count`, `cited`, `cover`, `docloc`, `link`, `aut_type`, `dowloadable`, `refkey`) VALUES (NULL, ?, ?, CURRENT_DATE, ?, ?, ?, '0', 'Unpublished', '1', '0', '0', '', '', ?, ?, ?, '')";
    		...
    		$stmt->bind_param("ssissssi", $_POST['title'], $_POST['abstract'], $_POST['department'], $_POST['keywords'], $_POST['references'], $loc, $aut_type, $isDownload);
