                    ...
                    <div class="modal-body m-2">
                        <div class="container" style="font-size: 11pt;">
                            <?php 
                                ...
                                <div class="col-*-12">
                                    <a href="#"><strong>Klevie Jun R. Caseres</strong></a>&nbsp;<em class="bg-info text-white">'. $action .'d</em> you as an Author to the research titled <em><strong>Buksu Research Record Management System</strong></em>
                                </div>
                                <div class="col-*-12 pt-1 pb-1">
                                    <button type="button" class="btn btn-outline-success btn-sm btn-confim" onclick=\'working(this, ".btn-cancel","confim", "#spin", ".working", "server_script/author_request.php", '. $notif['id'] .', ".working-entry")\'>Confirm</button>
                                    <button class="btn btn-outline-danger btn-sm btn-cancel" onclick=\'working(this, ".btn-confim","cancel", "#spin", ".working", "server_script/author_request.php", '. $notif['id'] .', ".working-entry")\'>Cancel</button>
